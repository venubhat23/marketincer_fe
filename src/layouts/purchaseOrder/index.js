        ...
        <Paper sx={{ p: 2, mb: 4 }}>
          <TableContainer>
            <Table sx={{ tableLayout: 'fixed', width: '100%' }}>
              <TableHead>
                <TableRow>
                  <TableCell align="left" sx={headerCellStyle}>Purchase Order ID</TableCell>
            ...
            <>
              <DialogTitle>
                <Box display="flex" justifyContent="space-between" alignItems="center">
                  <Typography variant="h6">Purchase Order {selectedInvoice.invoiceNumber}</Typography>
        ...
        <Dialog open={openEditDialog} onClose={handleCloseEditDialog} maxWidth="lg" fullWidth>
          {editedInvoice && (
            <>
              <DialogTitle>
                <Box display="flex" justifyContent="space-between" alignItems="center">
                  <Typography variant="h6">{editMode ? 'Edit' : 'Add'} Purchase Order {editedInvoice.invoiceNumber}</Typography>
