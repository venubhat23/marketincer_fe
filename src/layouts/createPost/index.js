...
const CreatePost = () => {
  ...
  const mutation = useMutation({
    mutationFn: (payloadData) => {
      ...
      return axios.post(
        "https://marketincer-2.onrender.com/api/v1/posts",
        payloadData,
        {
          headers: {
  ...
  const draftHandler = async () => {
    ...
    try {
      ...
      await axios.post("https://marketincer-2.onrender.com/api/v1/posts/schedule", payloadData, {
        headers: {
  ...
  const handlePublish = async () => {
    ...
    try {
      const token = localStorage.getItem("userToken");
      await axios.post("https://marketincer-2.onrender.com/api/v1/posts", payloadData, {
        headers: {
          Authorization: `Bearer ${token}`,
        }
      });
